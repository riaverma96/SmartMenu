...
class BrowseViewController: UITableViewController, STPAddCardViewControllerDelegate, STPPaymentMethodsViewControllerDelegate, STPShippingAddressViewControllerDelegate {
    ...
    enum Demo: Int {
        ...
        var title: String {
            switch self {
            case .STPPaymentCardTextField: return "Add New Card"
            case .STPAddCardViewController: return "Pay with Debit Card"
            case .STPPaymentMethodsViewController: return "Pay with Credit Card"
            case .STPShippingInfoViewController: return "Deliver Info"
